...
<li>Shaped system and code-level architecture across multiple product streams beyond the core platform, advising teams on architectural direction, operational setup, and long-term maintainability.
